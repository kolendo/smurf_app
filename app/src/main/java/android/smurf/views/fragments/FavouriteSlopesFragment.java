...
import android.smurf.viewmodels.FavouriteSlopesViewModel;
...
public class FavouriteSlopesFragment extends ViewModelBaseFragment<FavouriteSlopesView, FavouriteSlopesViewModel> implements FavouriteSlopesView, SkiSlopesAdapter.OnItemClickedListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_favourite_slopes, container, false);
    }
    ...
    public static FavouriteSlopesFragment newInstance() {
        return new FavouriteSlopesFragment();
    }
